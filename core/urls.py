...
core_patterns = ([
    ...
    path('guardias/add', views.GuardiaCreateView.as_view(), name ='guardia_add'),
    path('guardias/search', views.GuardiasListView.as_view(), name ='guardias'),
    path('guardias/edit/<int:pk>', views.GuardiaUpdate.as_view(), name ='guardia_edit'),
